...
<div class="outter-wp">
	...
	<div class="graph-visual tables-main">
		...
		<h4>
			<a href="{!! URL::route('admin.article.getAddmenu')!!}" type="button" class="btn btn-default">
						...
						<tbody>
							...
							<tr>
								...
								@if($admin['role_id'] == 1 || $admin['id'] == $item['admin_id'])
									<a href="{!! URL::route('admin.article.getListmenusm',$item['id']) !!}" title="Danh mục con"><i class="fa fa-dropbox fa-2x" aria-hidden="true"></i></a>
									<a href="{!! URL::route('admin.article.getEditmenu',$item['id']) !!}" title="Sửa"><i class="fa fa-cog fa-2x" aria-hidden="true"></i></a>
				...
				<div id="{!! $item['id'] !!}" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<a href="{!! URL::route('admin.article.getDeletemenu',$item['id']) !!}" type="button" class="btn btn-default">Đồng ý</a>
