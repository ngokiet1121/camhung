...
<div class="outter-wp">
	...
	<div class="graph-visual tables-main">
		...
		<h4>
			<a href="{!! URL::route('admin.article.getAddmenusm')!!}" type="button" class="btn btn-default">
			...
			<div class="graph">
				<div class="data-table">
					<table id="list-table" class="table">
						...
						<tbody>
							<?php $stt = 0;?>
							@foreach($article_menusm as $item)
							<?php $stt = $stt + 1;?>
							<tr>
								<td>{!! $stt !!}</td>
								<td>{!! $item['name'] !!}</td>
								...
								@if($admin['role_id'] == 1 || $admin['id'] == $item['admin_id'])
									<a href="{!! URL::route('admin.article.getEditmenusm',$item['id']) !!}" title="Sửa"><i class="fa fa-cog fa-2x" aria-hidden="true"></i></a>
				...
				<div id="{!! $item['id'] !!}" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<a href="{!! URL::route('admin.article.getDeletemenusm',$item['id']) !!}" type="button" class="btn btn-default">Đồng ý</a>
