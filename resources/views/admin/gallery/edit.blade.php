		...
		<div class="set-1">
			<div class="graph-2 general">
				<h3 class="inner-tittle two">Thay đổi hình ảnh</h3>
                                <h4><a href="{!! URL::route('admin.gallery.getList')!!}" type="button" class="btn btn-default">
						...
						<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div id="image-holder" class="col-sm-2">
									<img src="{{ asset('') }}{!! old('img',isset($data)?$data['img'] : null ) !!}" class="thumb-image" alt="{!! old('img_note',isset($data)?$data['img_note'] : null ) !!}">
								</div>
							</div>
