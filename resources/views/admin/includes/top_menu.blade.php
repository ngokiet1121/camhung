				...
				<ul class="dropdown-menu two first">
					<li>
						...
						foreach ($data as $val) {
							...
							<li><a href="{!! URL::route('admin.contact.getList')!!}" >
					...
					<li>
						<div class="notification_bottom">
							<a href="{!! URL::route('admin.contact.getList')!!}">See all messages</a>
						</div> 
					</li>
				</ul>
			</li>
				...
				<ul class="dropdown-menu two">
					...
					<?php 
						foreach ($data as $val) {
							...
							<li><a href="{!! URL::route('admin.order.getList')!!}" >
								<div class="notification_desc">
									<p><?php print_r($val->email); ?></p>
					...
					<li>
						<div class="notification_bottom">
							<a href="{!! URL::route('admin.order.getList')!!}">See all notification</a>
						</div> 
					</li>
				</ul>
			</li>	
