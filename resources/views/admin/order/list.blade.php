							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a title="Xem" href="{!! URL::route('admin.order.getListdetail',$item['id'])!!}"><i class="fa fa-dropbox fa-2x" aria-hidden="true"></i></a>

											<a title="Sửa" href="{!! URL::route('admin.order.getEdit',$item['id'])!!}"><i class="fa fa-cog fa-2x" aria-hidden="true"></i></a>
										</td>
									</tr>
									@endforeach
								</tbody>
