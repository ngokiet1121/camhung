...
<script src="{{ asset('public/frontend/js/slick.js')}}" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
...
<script type="text/javascript">
	...
	<script type="text/javascript" src="{{ asset('public/frontend/javascripts/vendor/jquery.tabslet.min.js')}}"></script>
	<script type="text/javascript" src="{{ asset('public/frontend/javascripts/vendor/rainbow-custom.min.js')}}"></script>
	<script type="text/javascript" src="{{ asset('public/frontend/javascripts/vendor/jquery.anchor.js')}}"></script>
	<script src="{{ asset('public/frontend/javascripts/initializers.js')}}"></script>
<script type="text/javascript" src="{{ asset('public/frontend/js/jquery.auto-complete.js')}}"></script>
<script type="text/javascript" src="{{ asset('public/frontend/js/jquery.auto-complete.min.js')}}"></script>
