...
<div class="item-footer">
	<h4>Tên Khách Hàng : <?php echo e($name); ?></h4>
	<h4>Email : <?php echo e($email); ?></h4>
	<h4>Điện Thọai : <?php echo e($phone); ?></h4>
	<h4>Address: <?php echo e($address); ?></h4>
</div>
	...
	<tbody>
		...
		<tr >
			<td colspan="5">
				<h3 style="padding: 0;
				margin: 0;
				color:#f96332;">Tạm Tính : <?php echo e($totalPrice); ?> VNĐ</h3>
			</td>
		</tr>
	</tbody>
</table>
