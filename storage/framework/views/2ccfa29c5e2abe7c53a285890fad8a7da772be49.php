	...
	<div class="navigation">
		...
		<div class="nav-menu">
			...
			<ul>
				...
				<li class="parent"><a href="<?php echo e(route('product',$item['slug'])); ?>" alt="<?php echo e($item['name']); ?>" ><?php echo e($item['name']); ?></a>
					<?php 
			...
			<div class="search" >
				...
				<div class="search-menu">
					<div class="search-input">
						<form action="<?php echo e(asset('tim-kiem')); ?>" method="PORT" >
			...
			<div class="slide-show">
				<div class="single-item-rtl sliders">
					...
					<?php foreach($images as $element): ?>
						<div>
							<img src="<?php echo e(asset('')); ?>/<?php echo $element->img; ?>" />
						</div>
					<?php endforeach; ?>
				</div>
			</div>
