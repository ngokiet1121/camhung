...
<div class="outter-wp">
	...
	<div class="graph-visual tables-main">
		...
		<h4>
			<a href="<?php echo URL::route('admin.product.getAddmenu'); ?>" type="button" class="btn btn-default">
						...
						<tbody>
							...
							<tr>
								...
								<?php if($admin['role_id'] == 1 || $admin['id'] == $item['admin_id']): ?>
									<a href="<?php echo URL::route('admin.product.getListmenusm',$item['id']); ?>" title="Danh mục con"><i class="fa fa-dropbox fa-2x" aria-hidden="true"></i></a>
									<a href="<?php echo URL::route('admin.product.getEditmenu',$item['id']); ?>" title="Sửa"><i class="fa fa-cog fa-2x" aria-hidden="true"></i></a>
				...
				<div id="<?php echo $item['id']; ?>" class="modal fade" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<a href="<?php echo URL::route('admin.product.getDeletemenu',$item['id']); ?>" type="button" class="btn btn-default">Đồng ý</a>
