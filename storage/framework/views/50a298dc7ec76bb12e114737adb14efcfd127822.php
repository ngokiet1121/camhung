					...
					<div class="form-body">
						<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" class="form-control1" id="" name="name" value="<?php echo old('name',isset($admin)?$admin['name'] : null ); ?>" required>
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Điện thoại</label>
								<div class="col-sm-6">
									<input type="text" class="form-control1" id="" name="phone" value="<?php echo old('phone',isset($admin)?$admin['phone'] : null ); ?>" required>
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-2 control-label">Địa chỉ</label>
								<div class="col-sm-6">
									<input type="text" class="form-control1" id="" name="address" value="<?php echo old('address',isset($admin)?$admin['address'] : null ); ?>" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div id="image-holder" class="col-sm-2">
									<img src="<?php echo e(asset('')); ?><?php echo old('img',isset($admin)?$admin['img'] : null ); ?>" class="thumb-image" alt="">
								</div>
							</div>
							<!-- <div class="form-group">
